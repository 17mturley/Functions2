...
const dividedNum = numbers.map(function(num){
  return num / 2
})
...
const cityEndsWithI = cities.filter(function(city){
...
const totalRiceFoodPrice = foods.reduce(function(total, food){
...
// THE TOTAL
console.log(totalRiceFoodPrice)
//36